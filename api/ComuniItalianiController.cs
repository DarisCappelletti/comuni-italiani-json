...
namespace PortFolio.comuni_italiani_json.api
{
    public class ComuniItalianiController : ApiController
    {
            ...
            using (var mss = new MemoryStream())
            {
                ...
                while (excelReader.Read())
                {
                    if (i != 0 && excelReader.GetString(6).ToLower().Contains(comune))
                    {
                        ...
                        var dettagliEnte = RicercaEnteIndicePA(obj.DenominazioneItaliana);
        ...
        private RootDettagliEnte RicercaEnteIndicePA(string nomeEnte)
        {
            ...
            else if (ente != null && ente.result.num_items > 1)
            {
                ...
                var dettagliEnte = RicercaDettagliEnteIndicePA(comune);
        ...
        private RootDettagliEnte RicercaDettagliEnteIndicePA(string cod_amm)
        {
